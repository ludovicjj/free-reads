...
#---windows---#
 ## get current directory for window
current_dir := $(shell powershell -NoProfile -Command "Convert-Path .")
#------------#

#---PHPQA---#
PHPQA = jakzal/phpqa:php8.1
PHPQA_RUN = $(DOCKER_RUN) --init -it --rm -v "$(current_dir):/project" -w /project $(PHPQA)
#------------#
